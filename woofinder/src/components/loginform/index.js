    ...
    <div>
      ...
      >
        <BootstrapDialogTitle variant="h4" sx={{ mt: 1, ml: 3, fontFamily: 'Segoe UI', fontWeight: 'bold', textTransform: "uppercase" }} id="customized-dialog-title" onClose={handleClose}>
          Zaloguj się. Nie masz jeszcze konta? <Button variant="text" sx={{ fontSize: '0.8em', mt: 1, mr: 12, textTransform: 'capitalize', fontWeight: 'bold' }} autoFocus onClick={handleClose}>
            Zarejestruj się
          </Button>
